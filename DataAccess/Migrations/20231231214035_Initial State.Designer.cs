...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231231214035_Initial State")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Entities.PaymentHistoryItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataAccess.Entities.SubscriptionHistoryItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataAccess.Entities.PaymentHistoryItem", b =>
                {
                    b.HasOne("DataAccess.Entities.SubscriptionPlan", "Plan")
                        .WithMany()
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataAccess.Entities.Product", b =>
                {
                    b.HasOne("DataAccess.Entities.SubscriptionPlan", null)
                        .WithMany("Products")
